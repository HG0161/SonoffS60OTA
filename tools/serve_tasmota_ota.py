...
def main():
    ...
    parser.add_argument("--firmware", type=Path, default=Path("artifacts/s60-ota-bridge-v2-1.2.1.ota"))
    parser.add_argument("--email", required=True)
    parser.add_argument("--country-code", default="+44")
    parser.add_argument("--region", default="eu")
    parser.add_argument("--expected-current-version", default="1.2.0")
    parser.add_argument("--mdns-capture", type=Path, default=Path("captures/mdns-current.json"))
